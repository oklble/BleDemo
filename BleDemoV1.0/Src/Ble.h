...
// 625us	  (1/64000)*40=625us
#define LFCLK_625US 		40UL
// 1ms	  (1/64000)*60=1000s
#define LFCLK_1MS 			64UL 

//TX_PRE *  HFCLK_1MS = 7ms
#define TX_PRE   			7    
...
//200ms
#define BLE_INTERVAL_TIME	(200UL*LFCLK_1MS)

//3ms
#define	BLE_START_TIME		(1UL*HFCLK_1MS)
